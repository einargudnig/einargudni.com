...
export default function NowPlaying() {
  ...
  return (
    ...
    <div className="relative h-64 w-full mb-4">
      <Image src={data?.albumImageUrl} layout="fill" objectFit="cover" className="rounded-lg" alt="album cover" />
    </div>
    <h2 className="text-gray-700 text-lg font-semibold mb-2">{data?.title}</h2>
