  ...
  return (
    <section>
      ...
      <div className="prose prose-neutral dark:prose-invert text-neutral-800 dark:text-neutral-200">
        ...
        <p>
          I&apos;m very dedicated to learn new things and to truly believe that you should never stop learning.
          I enjoy creating different things, whether that be websites, application or anything in between.
        </p>
        <p className="mb-8">
          At my first full-time job as a developer I feel like I&apos;ve been very lucky to experience a broad and
          diverse part of projects and tasks. I get to deal with everything from user feedback, design and to
          backend tests and improving parts of our daily operations.
        </p>
        <div className="flex flex-col gap-2 md:flex-row md:gap-2 mb-6">
          <a
