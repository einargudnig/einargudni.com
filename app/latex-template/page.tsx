...
export default async function LatexTemplatePage() {
  ...
  `;
	...
	return (
		<div>
			<div>
				<h2 className="font-bold text-3xl font-serif mb-5">Latex Template</h2>
				<p>I didn&apos;t want to flood the book with too much code.</p>
				<br />
				<p>
					Here below you can see the bigger examples of latex code. You can easily
					copy/paste this code to overleaf.
				</p>
				<br />
				<p>This page is not very mobile friendly!</p>
			</div>
			...
			<div>
				<div className="my-3">
					<span>
						...
						<span className="text-neutral-300">page 20</span>{' '}
					</span>
					<br />
					<span className="mt-3 text-xs">
						Remember that you have to import photos to overleaf for them to be visible!
					</span>
					<SyntaxHighlighter language="latex" style={dracula} wrapLines={true}>
						{images}
					</SyntaxHighlighter>
				</div>
				<div className="my-3">
					<h3 className="text-lg font-semibold">
						...
						<span className="text-neutral-300">smaller template</span>
					</h3>
				</div>
				<div className="my-3">
					<span>
						Latex code for the preamble for the smaller template on{' '}
						<span className="text-neutral-300">page 26</span>
					</span>
					<SyntaxHighlighter language="latex" style={dracula}>
						{preamble}
					</SyntaxHighlighter>
				</div>
				<div className="my-3">
					<span>
						...
						<span className="text-neutral-300">page 28</span>
					</span>
					<SyntaxHighlighter language="latex" style={dracula}>
						{title}
					</SyntaxHighlighter>
				...
				<div className="my-3">
					<span>
						...
						<span className="text-neutral-300">page 30</span>
					</span>
					<SyntaxHighlighter language="latex" style={dracula}>
						{smallTemplate}
					</SyntaxHighlighter>
				...
				<div className="my-3">
					<h3>
						...
						<span className="text-neutral-300">Bigger template</span>
					</h3>
				</div>
				<div className="my-3">
					<span>
						Preamble for the bigger template on{' '}
						<span className="text-neutral-300">page 35</span>
					</span>
					<SyntaxHighlighter language="latex" style={dracula}>
						{bigPreamble}
					</SyntaxHighlighter>
				...
				<div className="my-3">
					<span>
						...
						<span className="text-neutral-300">page 38</span>
					</span>
					<SyntaxHighlighter language="latex" style={dracula}>
						{titleAndPreamble}
					</SyntaxHighlighter>
				...
				<div className="my-3">
					<span>
						...
						<span className="text-neutral-300">page 45</span>. This is the whole
						template.
					</span>
					<SyntaxHighlighter language="latex" style={dracula}>
						{bigTemplate}
