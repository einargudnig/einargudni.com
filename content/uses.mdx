...
I did not do too much but I addeed an option for you guys to 'play'.

I encourage you to press the 'I use this!' button on the tools you use.

It will send a request to my [datbase](https://planetscale.com/) and increment the count of people using this tool.
